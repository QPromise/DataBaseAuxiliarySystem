 ...
 */
public interface CountySecondIndexDataMapper {
	 ...
	 * @return
	 */
	List<ThirdIndexData> listSecondIndexDataByDesignation(String designation);

	// --------------------------------------------------------------
	/**
	 * 插入二级指标
	 */
	void insertSecondIndexDataAlter(ThirdIndexData thirdIndexData);
	 ...
	 * @return
	 */
	List<ThirdIndexData> listSecondIndexDataByDesignationAlter(String designation);
}

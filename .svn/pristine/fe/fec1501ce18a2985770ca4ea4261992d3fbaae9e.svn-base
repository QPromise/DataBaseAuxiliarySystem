	...
	<script type="text/javascript">
		...
		function queryAccountRecord() {
			...
			$.ajax({
				dataType : 'json',
				type : 'POST',
				url : '${pageContext.request.contextPath}/DataController/listWeightValueByIndex.action',
				data : "id=" + id,
		...
		$("#btn_update").click(function() {
			...
			$.ajax({
				dataType : 'json',
				type : 'POST',
				url : '${pageContext.request.contextPath}/DataController/updateIndexWeightById.action',

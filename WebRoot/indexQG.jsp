		...
		<div class="sidebar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li><a href="#"><i class="fa fa-file-text"></i> <span
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem"
							href="${pageContext.request.contextPath}/pages/county/add.jsp">海洋强国数据录入</a></li>
						<li><a class="J_menuItem"
				...
				<li><a href="#"><i class="fa fa-bar-chart"></i> <span
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem"
							href="${pageContext.request.contextPath}/pages/county/analysisQG.jsp">海洋强国数据分析</a></li>
						<li><a class="J_menuItem"
				...
				<li><a href="#"><i class="fa fa-pencil-square-o"></i> <span
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem"
							href="${pageContext.request.contextPath}/pages/county/weight.jsp">海洋强国权重修改</a></li>
						<li><a class="J_menuItem"
				...
				<li><a href="#"><i class="fa fa-pencil"></i> <span
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem"
							href="${pageContext.request.contextPath}/pages/county/reviseQG.jsp">海洋强国数据校正
						</a></li>
						<li><a class="J_menuItem"
							href="${pageContext.request.contextPath}/pages/province/revise.jsp">海洋强省数据校正</a></li>
						<li><a class="J_menuItem"
							href="${pageContext.request.contextPath}/pages/city/revise.jsp">海洋强市数据校正</a></li>
					</ul></li>
				<li><a href="#"><i class="fa fa-line-chart"></i> <span
						class="nav-label">校正数据分析</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem"
							href="${pageContext.request.contextPath}/pages/county/analysisAlterQG.jsp">海洋强国数据分析</a></li>
						<li><a class="J_menuItem"

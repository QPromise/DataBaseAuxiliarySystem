...
<%-- 							href="${pageContext.request.contextPath}/pages/county/add.jsp">海洋强县数据录入</a></li> --%>
				...
				<li><a href="#"><i class="fa fa-bar-chart"></i> <span
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem"
							href="${pageContext.request.contextPath}/pages/province/analysisTJ.jsp">海洋强省数据分析</a></li>
						<!-- 						<li><a class="J_menuItem" -->
...
<%-- 							href="${pageContext.request.contextPath}/pages/city/weight.jsp">海洋强市权重修改</a></li> --%>
				...
				<li><a href="#"><i class="fa fa-pencil"></i> <span
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem"
							href="${pageContext.request.contextPath}/pages/province/reviseTJ.jsp">海洋强省数据校正</a></li>
<!-- 						<li><a class="J_menuItem" href="">海洋强市数据校正</a></li> -->
<!-- 						<li><a class="J_menuItem" href="">海洋强县数据校正</a></li> -->
					</ul></li>
				<li><a href="#"><i class="fa fa-line-chart"></i> <span
						class="nav-label">校正数据分析</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem"
							href="${pageContext.request.contextPath}/pages/province/analysisAlterTJ.jsp">海洋强省数据分析</a></li>
						<!-- 						<li><a class="J_menuItem" -->

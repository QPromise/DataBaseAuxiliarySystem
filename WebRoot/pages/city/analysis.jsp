	...
	<script type="text/javascript">
		...
		function queryAccountRecord() {
			...
			$.ajax({
				dataType : 'json',
				type : 'POST',
				url : '${pageContext.request.contextPath}/CityDataController/listIndexDataByDesignation.action',
	...
	<script type="text/javascript">
		$("#btn_query_comprehensive").click(function() {
			$.ajax({
				dataType : 'json',
				type : 'POST',
				url : '${pageContext.request.contextPath}/CityDataController/comprehensiveIndexQuery.action',
				success : function(data) {
					var e = echarts.init(document.getElementById("echarts-line-chart")),
						a = {
							title : {

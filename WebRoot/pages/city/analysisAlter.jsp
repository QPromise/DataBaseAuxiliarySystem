	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$.ajax({
				dataType : 'json',
				type : 'POST',
				url : '${pageContext.request.contextPath}/CityDataController/listFirstIndexMetadata.action',
		...
		$("#sel_first_index").on("select2:select", function(e) {
			...
			if (designation != '一级指标') {
				...
				$.ajax({
					dataType : 'json',
					type : 'POST',
					url : '${pageContext.request.contextPath}/CityDataController/listSecondIndexMetadata.action',
		...
		$("#sel_second_index").on("select2:select", function(e) {
			...
			if (designation != '二级指标') {
				...
				$.ajax({
					dataType : 'json',
					type : 'POST',
					url : '${pageContext.request.contextPath}/CityDataController/listThirdIndexMetadata.action',
					data : "designation=" + designation,
					success : function(data) {
						//将市清空并赋值
		...
		$("#sel_third_index").on("select2:select", function(e) {
			...
			if (designation != '三级指标') {
				...
				$.ajax({
					dataType : 'json',
					type : 'POST',
					url : '${pageContext.request.contextPath}/CityDataController/listFourthIndexMetadata.action',
					data : "designation=" + designation,
					success : function(data) {
						//将市清空并赋值
		...
		function queryAccountRecord() {
			...
			$.ajax({
				dataType : 'json',
				type : 'POST',
				url : '${pageContext.request.contextPath}/CityDataController/listIndexDataByDesignationAlter.action',
	...
	<script type="text/javascript">
		$("#btn_query_comprehensive").click(function() {
			$.ajax({
				dataType : 'json',
				type : 'POST',
				url : '${pageContext.request.contextPath}/CityDataController/comprehensiveIndexQueryAlter.action',
				success : function(data) {
					var e = echarts.init(document.getElementById("echarts-line-chart")),
						a = {
							title : {

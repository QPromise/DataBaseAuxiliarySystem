	...
	<script type="text/javascript">
		...
		function querey() {
			...
			$.ajax({
				...
				dataType : 'json',
				type : 'POST',
				url : '${pageContext.request.contextPath}/CityDataController/getFourthIndexDataAndReviseData.action',
				success : function(data) {
		...
		function save() {
			...
			$.ajax({
				url : '${pageContext.request.contextPath}/CityDataController/updateFourthIndexDataAlter.action',

	...
	<script type="text/javascript">
		...
		function queryAccountRecord() {
			...
			$.ajax({
				dataType : 'json',
				type : 'POST',
				url : '${pageContext.request.contextPath}/DataController/listIndexDataByDesignationAlter.action',
	...
	<script type="text/javascript">
		$("#btn_query_comprehensive").click(function() {
			$.ajax({
				dataType : 'json',
				type : 'POST',
				url : '${pageContext.request.contextPath}/DataController/comprehensiveIndexQueryAlter.action',
				success : function(data) {
					var e = echarts.init(document.getElementById("echarts-line-chart")),
						a = {
							title : {

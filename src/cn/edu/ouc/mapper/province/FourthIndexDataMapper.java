...
public interface FourthIndexDataMapper {
	 ...
	 * @return
	 */
	Integer updateFourthIndexDataAlterById(@Param("indexId") Integer indexId, @Param("year") String year, @Param("reviseValue") Double reviseValue,
			@Param("isExclude") Integer isExclude);

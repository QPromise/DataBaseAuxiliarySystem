...
public interface DataService {
	 ...
	 * @return
	 */
	List<ReviseDataVO> getFourthIndexDataAndReviseDataByFirstIndex(String designation) throws Exception;
	/**
	 * 根据一级指标查询四级指标数据
	 * 
	 * @param designation
	 * @return
	 */
	List<ReviseDataVO> getFourthIndexDataAndReviseDataBySecondIndex(String designation) throws Exception;
	/**
	 * 根据一级指标查询四级指标数据
	 * 
	 * @param designation
	 * @return
	 */
	List<ReviseDataVO> getFourthIndexDataAndReviseDataByThirdIndex(String designation) throws Exception;
	/**
	 * 根据一级指标查询四级指标数据
	 * 
	 * @param designation
	 * @return
	 */
	List<ReviseDataVO> getFourthIndexDataAndReviseDataByFourthIndex(String designation) throws Exception;
	
	Boolean updateFourthIndexDataAlter(List<ReviseDataVO> reviseDataVOs) throws Exception;

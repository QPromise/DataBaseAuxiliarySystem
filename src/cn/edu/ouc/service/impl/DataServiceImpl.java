...
import cn.edu.ouc.mapper.province.FirstIndexDataMapper;
...
import cn.edu.ouc.mapper.province.GrowthRateMapper;
import cn.edu.ouc.mapper.province.SecondIndexDataMapper;
import cn.edu.ouc.mapper.province.SecondIndexMetadataMapper;
import cn.edu.ouc.mapper.province.SynthesizeDataMapper;
import cn.edu.ouc.mapper.province.ThirdIndexDataMapper;
...
public class DataServiceImpl implements DataService {
	...
	@Autowired
	private FirstIndexDataMapper firstIndexDataMapper;
	...
	@Autowired
	private SecondIndexDataMapper secondIndexDataMapper;

	// 三级指标
	@Autowired
	private ThirdIndexMetadataMapper thirdIndexMetadataMapper;
	@Autowired
	private ThirdIndexDataMapper thirdIndexDataMapper;
	@Autowired
	...
	@Autowired
	private SynthesizeDataMapper synthesizeDataMapper;
	...
	public FoldLineDiagram listFourthIndexDataByDesignation(String designation, Integer id) throws Exception {
		...
		if (listDataByDesignationForth != null) {
			...
			for (int i = 0; i < listDataByDesignationForth.size(); i++) {
				...
				// if("2009".equals(listDataByDesignationForth.get(i).getYear())){
				// transverseValues[i] =
	...
	public List<Select2> listFirstIndexMetadata() throws Exception {
		...
		// select2Designations.add(new Select2(0, "综合指标"));
